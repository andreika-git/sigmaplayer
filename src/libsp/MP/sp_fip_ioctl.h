...
/// Repeats current button press.
/// The button to be received is set to be received twice.
/// This will destroy unread queued up presses.
#define FIP_BUTTON_REPEAT           0x450000
